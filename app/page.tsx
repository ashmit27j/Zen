  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-50 to-zinc-100 dark:from-zinc-900 dark:to-zinc-800 transition-colors duration-300">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className={`grid gap-6 ${isFullscreen ? "" : "md:grid-cols-2 lg:grid-cols-3"}`}>
          <div className={`${isFullscreen ? "flex justify-center items-center min-h-[80vh]" : "lg:col-span-1"}`}>
            <PomodoroTimer
