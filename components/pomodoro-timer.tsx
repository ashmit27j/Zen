...
export function PomodoroTimer({ isFullscreen, setIsFullscreen, showQuote, setShowQuote }: PomodoroTimerProps) {
  ...
  return (
    <Card
      className={`w-full max-w-md mx-auto shadow-md ${isFullscreen ? "scale-125" : ""} transition-all duration-300`}
    >
        ...
        <div className="flex flex-col items-center">
          {!isFullscreen && (
            <Tabs
              ...
              onValueChange={(value) => setTimerMode(value as "focus" | "shortBreak" | "longBreak")}
            >
